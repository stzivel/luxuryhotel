      ...
      <div className="about__content">
        ...
        <div className="about__content-text">
          ...
          <p>
            ...
            belonged to the family, has been completely renovated with care &
            passion while respecting the spirit of place.
          </p>
          <br></br>
          <p>
            Divo Hotel surrounded herself by a team of French artisans to create
            a sophisticated place in a refined.
          </p>
